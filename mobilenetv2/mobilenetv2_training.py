...
# ✅ Model (MobileNetV2)
model = create_model('mobilenetv2_100', pretrained=True, num_classes=len(train_dataset.classes))
model.to(device)
...
# ✅ Run Training
for epoch in range(25):  # You can increase or decrease this
    train_one_epoch(epoch)
    evaluate(val_loader)

# ✅ Save model weights
torch.save(model.state_dict(), "mobilenetv2_weights.pt")
print("Saved weights to mobilenetv2_weights.pt")
...
# ✅ Confusion Matrix with custom green-dark color scheme
colors = [(0.9, 1, 0.9), (0, 0.3, 0)]  # Very Light Green to Dark Green
custom_cmap = LinearSegmentedColormap.from_list('lightgreen_to_darkgreen', colors)
