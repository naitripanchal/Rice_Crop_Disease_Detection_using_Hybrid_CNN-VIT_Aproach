...
# ✅ Model (DeiT Tiny)
model = create_model('deit_tiny_patch16_224', pretrained=True, num_classes=len(train_dataset.classes))
model.to(device)
...
# ✅ Save model weights
torch.save(model.state_dict(), "deit_tiny_weights.pt")
print("Saved weights to deit_tiny_weights.pt")
...
# ✅ Confusion Matrix with Custom Very Light Green to Dark Blue Colormap

# Define custom colormap: very light green to dark blue
