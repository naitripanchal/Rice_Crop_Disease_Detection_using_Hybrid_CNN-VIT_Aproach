...
# ✅ Model (ResNet50)
model = create_model('resnet50', pretrained=True, num_classes=len(train_dataset.classes))
model.to(device)
...
# ✅ Save model weights
torch.save(model.state_dict(), "resnet50_weights.pt")
print("Saved weights to resnet50_weights.pt")
...
colors = [(0.9, 1, 0.9), (0, 0.3, 0)]  # Light to dark green
